<i18n>
{
  "de": {
    ...
    "description_all": "2017 wurden durch die EU 4168 Gigatonnen (Milliarden Tonnen) Treibhausgas-Emissionen produziert. Damit liegt die EU weltweit auf Platz 3, hinter den USA und China. Im Ländervergleich unterscheiden sich die einzelnen Sektoren oft in ihren Anteilen.",
  ...
  "en": {
    ...
    "sector_agriculture": "Agriculture",
    "sector_other": "Other",
    "description_all": "In 2017 the EU produced 4168 Gigatons (billion tons) of greenhouse gases. This makes the EU the 3rd biggest global greenhouse gas emitter, after the USA and China. However, individual EU nations differ both in how much each sector contributes, and their overall contribution to total EU emissions.",
    ...
    "description_energy": "When it comes to energy generation, the burning of brown coal in particular contributes heavily to CO₂ emissions - the use of fuels such as petrol also doesn't help. This is one of the biggest sectors in terms of emissions, contributing 28% of the EU's total CO₂ output.",
