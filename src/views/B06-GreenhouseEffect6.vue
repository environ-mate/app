<i18n>
{
  "de": {
    ...
    "description_all": "2017 wurden durch die EU 4168 Gigatonnen Treibhausgas-Emissionen produziert. Damit liegt die EU weltweit auf Platz 3 hinter den USA und China. Im Ländervergleich unterscheiden sich die einzelnenSektoren oft in ihren Anteilen.",
    "description_agriculture": "In der Landwirtschaft wird der größte Anteil an nicht CO₂-Gasen erzeugt. NO₂ entsteht bei der Düngung der Felder. CH₄ (Methan) bei der Verdauung in Nutztieren (Kühe, Schweine, Schafe, …) und Reisanbau. Dieser Sektor hat einen Gesamtanteil in der EU von 10%.",
    "description_energy": "Bei der Stromerzeugung werden gerade durch die Verbrennung von Braunkohle viele CO₂-Emissionen freigesetzt aber auch bei der Herstellung von Treibstoff und Benzin entstehen Emissionen. Dies ist mit 28% Anteil einer der größten Sektoren.",
    "description_waste": "Abfall beinhaltet alles rund umd die Müll- und Abwasserverarbeitung (Entsorgung, Kompostierung, Verbrennung, Wasseraufbereitung/klärung. Auf diesen Sektor entfallen EU-weit 3%.",
    ...
    "description_other": "Hierin sind verschiedene Sektoren zusammengefasst wobei die EU-weit über 50% aus den Emissionen in Gebäuden (Heizung, Abwasser, Strom in Wohnungen oder Geschäften) stammen. Dieser Sektor hat einen Gesamtanteil von 28% an allen Emissionen.",
  ...
  "en": {
    ...
    "sector_agriculture": "Agriculture",
    "sector_other": "Other",
    "description_all": "In 2017 the EU produced 4168 Gigatons of greenhouse gases. This makes the EU the 3rd biggest global greenhouse gas emitter, after the USA and China. However, individual EU nations differ both in how much each sector contributes, and their overall contribution to total EU emissions. This sector is responsible for 21% of the total emissions in the EU.",
