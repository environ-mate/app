<i18n>
{
  "de": {
    ...
    "desc_1": "Den größten Anteil hat CO2 und durch den Autoverkehr und die Verbrennung fossiler Brennstoffe (Gas, Erdöl, Kohle) entstehen die meisten Emissionen (Ausstoß an Gasen in die Umwelt). ",
