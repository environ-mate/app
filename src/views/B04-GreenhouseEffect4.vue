<i18n>
{
  "de": {
    ...
    "desc_1": "Den größten Anteil am Treibhauseffekt hat das Gas CO2. Der Autoverkehr und die Verbrennung fossiler Brennstoffe (Gas, Erdöl, Kohle) verursachen die meisten CO2-Emissionen (Ausstoß des Gases in die Umwelt). ",
