<i18n>
{
  "de": {
	...
	"act_6": "Entwickle deine eigenen Stories mit Environ-Mate und hilf dabei das Verständnis des Klimawandel zu verbessern: <a class='text-break' href='https://github.com/environ-mate/' target='_blank'>https://github.com/environ-mate/app</a>",
  ...
  "en": {
	...
	"act_6": "Develop your own Stories with Environ-Mate and help improve the understanding of climate change: <a class='text-break' href='https://github.com/environ-mate/' target='_blank'>https://github.com/environ-mate/app</a>",
