...
# replace country codes where necessary
ghg_emissions_projections$country.code[ghg_emissions_projections$country.code=="GB"] <- "GB"
...
# EM-DAT: The Emergency Events Database - Universit� catholique de Louvain (UCL) - CRED, www.emdat.be, Brussels, Belgium. Classification: https://emdat.be/classification
